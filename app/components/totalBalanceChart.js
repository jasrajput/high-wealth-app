...
const BalanceChart = ({ headerTitle, header, onSend, onReceive, balance, balanceUSD, credit, tokenImage, currency = '' }) => {
    ...
    return (
        ...
        >
            ...
            <Text style={{ ...FONTS.xs, color: COLORS.white }}>
                Total Credits - ${credit != null ? parseFloat(credit).toFixed(2).toString() : '0.00'}
            </Text>
